...
function spotify_query {
    /usr/lib/qt4/bin/qdbus org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.freedesktop.DBus.Properties.Get org.mpris.MediaPlayer2.Player $1 2>/dev/null
}
...
case "$1" in
    ...
    spotify:*:*)
        ...
        ;;
    playstatus)
        spotify_query PlaybackStatus
        ;;
    info)
        spotify_query Metadata
        ;;
    *)
        echo -e "Bad argument.\n"
        quit_message
